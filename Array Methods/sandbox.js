...
console.log(saleProducts, products);
    ...
    //Reduce method  - накапливает результат в acc а в curr принимает текущий элемент , в конце отдает нам колличество цифр которые > 50, а то есть 3,а параметр начала "0" стоит в конце тале ф-и 
